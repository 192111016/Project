...
<head>
    ...
    <title>SalonSensei Studio || Appointments Form</title>
    <!-- Bootstrap -->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            ...
                            <ul class="listnone contact">
                                <li><i class="fa fa-map-marker"></i> No.7,Menambedu,Ambattur,chennai-600053 </li>
                                <li><i class="fa fa-phone"></i> 9940618604</li>
                                <li><i class="fa fa-envelope-o"></i> sanjaysenthil0044@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p>© SalonSensei Studio 2023 | all rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
