...
(1, 'aboutus', 'About Us', 'At SalonSensei Studio , we understand that beauty is a personal expression, and our mission is to help you discover and enhance your individual style. Our talented hairstylists and beauty experts stay up-to-date with the latest trends, techniques, and products to ensure that you receive the highest quality of service and achieve the look you envision.

Step into our modern and luxurious salon studio, meticulously designed to create a serene environment that will transport you into a world of relaxation and rejuvenation. We believe in pampering our clients, offering a wide range of services, including precision haircuts, vibrant hair coloring, rejuvenating facials, flawless makeup application, and much more.', NULL, NULL, NULL, ''),
