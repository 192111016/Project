...
<head>
    ...
    <title>SalonSensei Studio || Home Page</title>
    <!-- Bootstrap -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <h1 class="hero-title">SalonSensei Studio</h1>
                    <p class="hero-text"><strong>Unlock Your Signature Style, Unleash Your Inner Beauty.</strong> </p>
